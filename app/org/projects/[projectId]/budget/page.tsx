...
export default async function BudgetPage({ params }: { params: Promise<{ projectId: string }> }) {
    ...
    return (
        <div className="m-5 w-full">
            ...
            <div className="mt-5 rounded-lg border-1 shadow-lg shadow-slate-200">
                <div className="flex flex-wrap gap-x-16 mt-5 justify-center mx-10">
            ...
            <div className="mt-8 flex flex-wrap md:flex-nowrap gap-y-5 gap-x-10 font-semibold ">
